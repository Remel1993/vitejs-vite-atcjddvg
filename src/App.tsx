...
const PRESETS = {
  ES: [
    ...
    { name: 'FC Barcelona', att: 5, opp: 5, def: 3, color1: '#a71930', color2: '#004d98', league: 'ES' },
    ...
    { name: 'Real Sociedad', att: 3, opp: 3, def: 3, color1: '#004d98', color2: '#ffffff', league: 'ES' },
    { name: 'Athletic Club', att: 3, opp: 4, def: 4, color1: '#cb3524', color2: '#000000', league: 'ES' },
    { name: 'Girona FC', att: 3, opp: 3, def: 3, color1: '#cb3524', color2: '#ffffff', league: 'ES' },
    { name: 'Real Betis', att: 4, opp: 4, def: 3, color1: '#16a34a', color2: '#ffffff', league: 'ES' },
    { name: 'Valencia CF', att: 2, opp: 3, def: 3, color1: '#ffffff', color2: '#000000', league: 'ES' },
    { name: 'Sevilla FC', att: 2, opp: 3, def: 3, color1: '#ffffff', color2: '#cb3524', league: 'ES' },
    { name: 'Osasuna', att: 2, opp: 3, def: 4, color1: '#cb3524', color2: '#1e3a8a', league: 'ES' },
    { name: 'Getafe', att: 2, opp: 2, def: 4, color1: '#1e3a8a', color2: '#ffffff', league: 'ES' },
    ...
    { name: 'Rayo Vallecano', att: 3, opp: 3, def: 4, color1: '#ffffff', color2: '#cb3524', league: 'ES' },
    { name: 'Las Palmas', att: 2, opp: 2, def: 2, color1: '#facc15', color2: '#1e3a8a', league: 'ES' },
    { name: 'Alavés', att: 2, opp: 3, def: 3, color1: '#1e3a8a', color2: '#ffffff', league: 'ES' },
    { name: 'Leganés', att: 1, opp: 2, def: 3, color1: '#ffffff', color2: '#1e3a8a', league: 'ES' },
    { name: 'Valladolid', att: 1, opp: 2, def: 2, color1: '#ffffff', color2: '#951b81', league: 'ES' },
  ...
  IT: [
    ...
    { name: 'Monza', att: 1, opp: 2, def: 2, color1: '#ffffff', color2: '#cb3524', league: 'IT' },
    ...
    { name: 'Empoli', att: 1, opp: 2, def: 2, color1: '#1e3a8a', color2: '#ffffff', league: 'IT' },
    ...
    { name: 'Venezia', att: 2, opp: 2, def: 2, color1: '#fb923c', color2: '#16a34a', league: 'IT' }
  ],
  EN: [
    ...
    { name: 'Ipswich Town', att: 2, opp: 2, def: 2, color1: '#1e3a8a', color2: '#ffffff', league: 'EN' },
    { name: 'Southampton', att: 1, opp: 2, def: 2, color1: '#cb3524', color2: '#ffffff', league: 'EN' }
  ],
  NL: [ 
    ...
    { name: 'Almere City', att: 1, opp: 1, def: 2, color1: '#ff0000', color2: '#000000', league: 'NL' },
    { name: 'RKC Waalwijk', att: 1, opp: 2, def: 2, color1: '#ffff00', color2: '#1e3a8a', league: 'NL' },
    { name: 'Willem II', att: 1, opp: 2, def: 2, color1: '#ff0000', color2: '#ffffff', league: 'NL' },
  ...
  DE: [ 
    ...
    { name: 'VfL Bochum', att: 1, opp: 2, def: 2, color1: '#005ca9', color2: '#ffffff', league: 'DE' },
    ...
    { name: 'Holstein Kiel', att: 1, opp: 2, def: 2, color1: '#0053a4', color2: '#ffffff', league: 'DE' }
  ],
  FR: [ 
    ...
    { name: 'Stade Reims', att: 2, opp: 2, def: 3, color1: '#e30613', color2: '#ffffff', league: 'FR' },
    ...
    { name: 'Montpellier', att: 1, opp: 2, def: 2, color1: '#0033a0', color2: '#f68712', league: 'FR' },
    ...
    { name: 'Saint-Étienne', att: 2, opp: 2, def: 2, color1: '#006532', color2: '#ffffff', league: 'FR' },
    ],
  MI: [ 
...
const PRESETS_2 = {
  ES: [
    ...
    { name: 'Real Oviedo', att: 3, opp: 3, def: 3, color1: '#00529f', color2: '#ffffff', league: 'ES' },
    ...
    { name: 'Elche CF', att: 4, opp: 4, def: 3, color1: '#ffffff', color2: '#006400', league: 'ES' },
  ...
  EN: [
    { name: 'Leeds United', att: 4, opp: 4, def: 3, color1: '#ffffff', color2: '#1d428a', league: 'EN' },
    { name: 'Burnley', att: 4, opp: 4, def: 3, color1: '#6c1d45', color2: '#87ceeb', league: 'EN' },
  ...
  IT: [
    { name: 'Sassuolo', att: 4, opp: 4, def: 3, color1: '#000000', color2: '#00a650', league: 'IT' },
    ...
    { name: 'Cremonese', att: 3, opp: 4, def: 3, color1: '#8b0000', color2: '#a9a9a9', league: 'IT' },
  ...
  DE: [
    { name: 'FC Köln', att: 4, opp: 4, def: 3, color1: '#e30613', color2: '#ffffff', league: 'DE' },
    { name: 'Darmstadt 98', att: 2, opp: 3, def: 3, color1: '#0033a0', color2: '#ffffff', league: 'DE' },
    { name: 'Hamburger SV', att: 4, opp: 4, def: 3, color1: '#ffffff', color2: '#0033a0', league: 'DE' },
  ...
  FR: [
    ...
    { name: 'Paris FC', att: 4, opp: 4, def: 3, color1: '#0033a0', color2: '#ffffff', league: 'FR' },
    ...
    { name: 'FC Metz', att: 3, opp: 4, def: 3, color1: '#6c1d45', color2: '#ffffff', league: 'FR' },
    { name: 'FC Lorient', att: 4, opp: 4, def: 3, color1: '#f68712', color2: '#000000', league: 'FR' }
  ],
  NL: [
    { name: 'Excelsior', att: 3, opp: 3, def: 2, color1: '#000000', color2: '#e30613', league: 'NL' },
    { name: 'Vitesse', att: 2, opp: 2, def: 2, color1: '#ffcc00', color2: '#000000', league: 'NL' },
    { name: 'FC Volendam', att: 3, opp: 4, def: 2, color1: '#f5a12d', color2: '#000000', league: 'NL' },
    ...
    { name: 'SC Telstar', att: 3, opp: 3, def: 2, color1: '#ffffff', color2: '#0033a0', league: 'NL' },
